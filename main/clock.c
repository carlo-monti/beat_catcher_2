...
const uart_port_t uart_num = UART_NUM_2;  /*!< ESP32 UART number 2 */
...
{   /**
    ...
    while (1)
    {
        ...
        if (xQueueReceive(clock_task_queue, &rx_buffer, 0))
        {
             ...
             */
            int onset_adc_queue_value; /*!< message to be sent to onset_adc_task */
        ...
        {               
            /**
             * This is executed only one time at the start
             */
